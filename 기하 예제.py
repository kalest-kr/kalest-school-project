...
while i <= 150:
    rate(100)
    platform1.rotate(angle=angle, axis=axis, origin=vec(0, 5, 0))  # 회전 적용
    line1.rotate(angle=angle, axis=axis, origin=vec(0, 5, (z_length / 2)))
    line2.rotate(angle=angle, axis=axis, origin=vec(0, 5, (-z_length / 2)))

    point1 = rotate(point1, angle=angle, axis=axis, origin=vec(0, 5, 0))
    point2 = rotate(point2, angle=angle, axis=axis, origin=vec(0, 5, 0))
    point3 = rotate(point3, angle=angle, axis=axis, origin=vec(0, 5, 0))
    point4 = rotate(point4, angle=angle, axis=axis, origin=vec(0, 5, 0))
